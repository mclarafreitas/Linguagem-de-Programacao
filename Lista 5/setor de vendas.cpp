...
int main(){
    ...
    if(vendas(x1,vetor1,entrar)){
        cout << "Sim, funcionário 1 vendeu um produto cujo valor foi " << valorx1 << endl;
    }
    else{
        cout << "Não, funcionário 1 não vendeu um produto cujo valor foi " << valorx1 << endl;    
        } 
        int valorx2 = x2;
    if(vendas(x2,vetor2,entrar2)){
        cout << "Sim, funcionário 2 vendeu um produto cujo valor foi " << valorx2 << endl;
    }
    else{
        cout << "Não, funcionário 2 não vendeu um produto cujo valor foi " << valorx2 << endl;    
        }
